    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-item nav-link active" href="painel.php"><?php echo $dados['nome']; ?> ADM<span class="sr-only">(Página atual)</span></a>
                <a class="nav-item nav-link" href="calendar.php">Calendário</a>
                <a class="nav-item nav-link" href="quest.php">Questionários</a>
