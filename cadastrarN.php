...
$crn = mysqli_real_escape_string($conexao, trim($_POST['crn']));
...
$sql = "SELECT count (*) AS total FROM nutricionista WHERE usuario = '$usuario'";
...
$sql = "INSERT INTO nutricionista (usuario, nome, cpf, rg, sexo, crn, data_nasc, email, endereco, telefone, senha, data_cadastro) VALUES ('$usuario', '$nome', '$cpf', '$rg', '$sexo', '$crn', '$data_nasc', '$email', '$endereco', '$telefone', '$senha', NOW())";
