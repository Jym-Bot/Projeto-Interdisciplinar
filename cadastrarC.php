...
$sql = "INSERT INTO cliente (usuario, nome, cpf, rg, sexo, data_nasc, email, endereco, telefone, senha, data_cadastro) VALUES ('$usuario', '$nome', '$cpf', '$rg', '$sexo', '$data_nasc', '$email', '$endereco', '$telefone', '$senha', NOW())";
