...
<body>
    ...
    ?>
        ...
        <div class="notification is-success">
            ...
            <p>Faça login informando o seu Usuário e Senha <a href="loginC.php">aqui</a></p>
        </div>
    ...
    <div class="text-center border border-light p-5">
        <form action="cadastrarC.php" method="POST">
            ...
            <div class="field">
                <div class="control">
                    ...
                    <input name="sexo" type="text" style="text-transform: uppercase;" class="form-control mb-4" placeholder="Sexo" maxlength="1">
                </div>
            </div>
            <div class="field">
                <div class="control">
        ...
        <a href="loginC.php">Realizar Login</a>
    </div>
</body>
<?php
